class LoginPage {
    ...
    get Logout1() {return $("//android.widget.Button[@text = 'log out']")};
  ...
  get Fname() {return $("//android.view.View[3]//android.widget.EditText")};
  get email() {return $("//android.view.View[1]//android.widget.EditText")};
...
//android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.webkit.WebView[1]/android.webkit.WebView[1]/android.view.View[1]/android.view.View[1]/android.view.View[1]/android.view.View[1]/android.view.View[1]/android.view.View[1]/android.view.View[2]/android.view.View[1]/android.view.View[2]/android.view.View[1]/android.view.View[3]/android.view.View[1]/android.view.View[1]/android.view.View[1]/android.view.View[2]/android.widget.EditText[1]
 ...
 //   get email() {return $("//android.view.View[2]/android.view.View[1]/android.view.View[1]//android.widget.EditText")};
...
//android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.webkit.WebView[1]/android.webkit.WebView[1]/android.view.View[1]/android.view.View[1]/android.app.Dialog[1]/android.view.View[2]/android.view.View[3]/android.view.View[1]/android.widget.EditText[1]
    ...
    get Resetall() {return $("//*[@text='Reset All']")};
    get successfullyremoved() {return $("//*[@text='Notification removed successfully']")};

    
    get Profile() {return $("//*[@text='Your Profile']")};
    get Update() {return $("//*[@text='Update']")};
    get Secure() {return $("//*[@text='Secure']")};
