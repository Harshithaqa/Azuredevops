...
exports.ReportData = exports.InternalReportEvent = exports.TestInfo = exports.SuiteInfo = exports.Metrics = exports.HtmlReporterOptions = void 0;
...
class SuiteInfo {
    constructor(type, suiteStats) {
        this.type = type;
        this.suite = suiteStats;
        this.tests = [];
    }
}
exports.SuiteInfo = SuiteInfo;
class TestInfo {
    constructor(test) {
        this.testStats = test;
        this.events = [];
